...
namespace HackPDM
{
    public partial class SearchDialog : Form
    {
       ...
       //     this.Load += new EventHandler(SearchDialog_)
            ...
            // Send the command:
            PropTypeMap = [];
            NpgsqlCommand command = new(strcomm, connDb);
            try
            {
        ...
        private void StoreSearchParams()
        {
            ...
            [
                ...
                cboProperty.Text,
                txtProperty.Text,
                cbxCheckedMe.Checked ? "1" : "0",
                cbxDeletedLocal.Checked ? "1" : "0",
                cbxLocalOnly.Checked ? "1" : "0",
            ];
        ...
        private bool GetResults_LocalOnly(int MAXCOUNT, ref DataTable dtSearchResults)
        {
            ...
            List<string> allLocal = new(strLocals);
            ...
            try
            {
                using (NpgsqlCommand cmdAllRemote = new(strGetAllEntries, connDb))
                {
            ...
            foreach (string s in allLocal)
            {
                ...
                dtSearchResults.Rows.Add([strRelPathForm, Utils.GetBaseName(s)]);
                resCount++;
            }
        ...
        private bool GetResults_LocalDeleted(int MAXCOUNT, ref DataTable dtSearchResults)
        {
            ...
            DataTable dtDeleted = new();
            NpgsqlCommand cmdGetResults = new(strGetAllDeleted, connDb);
            NpgsqlDataAdapter daGetResults = new(cmdGetResults);
            try
            {
        ...
        private bool GetResults_General(int MAXCOUNT, ref DataTable dtSearchResults)
        {
            ...
            // execute and retrieve data
            NpgsqlCommand cmdGetResults = new(strGetResults, connDb);
            NpgsqlDataAdapter daGetResults = new(cmdGetResults);
            try
            {
