...
namespace HackPDM
{
	class IconFromFile
	{
		...
		private static  System.Drawing.Size size = new(256, 256);
		...
		public Icon GetLargeFileIcon(string fileName)
		{
			...
			else
			{
				...
				{
                    FileInfo fileInfo = new(strTempName)
                    {
                        Attributes = FileAttributes.Temporary
                    };
		...
		public struct SHFILEINFO(bool b)
        {
            public IntPtr hIcon = IntPtr.Zero;
			public IntPtr iIcon = IntPtr.Zero;
			public uint dwAttributes = 0;
		...
		private Bitmap GetImageThumbnail(string FileName)
		{
			...
			try
			{
				using (Bitmap origBitmap = new(FileName))
				{
