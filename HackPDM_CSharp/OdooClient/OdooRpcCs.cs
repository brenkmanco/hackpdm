...
namespace OdooRpcCs
{
    public static class OdooClient
    {
        ...
        private static int commonTimeout = 3000;
        ...
        private static int objectTimeout = 5000;
        ...
        private static string latestException = "";
        ...
        public static int Login(int? timeout = null)
        {
            ...
            try
            {
                ...
                {
                    latestException = "login username or password failed";
                    return 0;
                }
    ...
    {
        private static string model = HpBaseModel<T>.GetHpModel();
        public static object Execute(string method, ArrayList parameters, int? timeout = null) 
            => OdooClient.Execute(model, method, parameters, timeout);
