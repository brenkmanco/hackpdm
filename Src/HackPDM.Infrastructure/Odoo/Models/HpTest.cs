...
public partial class HpTest : HpBaseModelTransport<HpTest>, IHpTestModel
{
	...
	[OdooProp(OdooFieldType.Many2One	, "many2one" )]	public Many2One? many2one	{ get; set; }
	[OdooProp(OdooFieldType.One2Many	, "one2many" )]	public One2Many? one2many	{ get; set; }
    [OdooProp(OdooFieldType.Many2Many	, "many2many")] public Many2Many? many2many { get; set; }
