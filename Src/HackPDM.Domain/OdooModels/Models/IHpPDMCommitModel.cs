...
public interface IHpPDMCommitModel : IHpOdooRecord
{
	...
	[OdooProp(OdooFieldType.Many2One, "node_by")] public IMany2One? node_by { get; set; }
	[OdooProp(OdooFieldType.One2Many, "staged_ids")] public IOne2Many? staged_ids { get;set;}
}